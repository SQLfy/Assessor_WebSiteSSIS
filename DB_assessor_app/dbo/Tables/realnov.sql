CREATE TABLE [dbo].[realnov] (
    ...
    [RESIDENTIALSF]         DECIMAL (10)    NULL,
    [STYLE]                 VARCHAR (18)    NULL,
    [QUALITY]               VARCHAR (15)    NULL,
    [YEARBUILT]             VARCHAR (10)    NULL,
    [HEATTYPE]              VARCHAR (18)    NULL,
    [BASEMENTSF]            DECIMAL (10)    NULL,
    [FINISHEDBSMNTSF]       DECIMAL (10)    NULL,
    [BASEMENTTYPE]          VARCHAR (10)    NOT NULL,
    [GARAGESF]              DECIMAL (10)    NULL,
    [IMPSF]                 DECIMAL (10)    NULL,
    [COMMERCIALSF]          DECIMAL (10)    NULL,
    [OUTBUILDINGSF]         DECIMAL (10)    NULL,
