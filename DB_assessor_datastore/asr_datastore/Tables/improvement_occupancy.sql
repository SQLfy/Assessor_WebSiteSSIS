CREATE TABLE [asr_datastore].[improvement_occupancy] (
    ...
    CONSTRAINT [fk_io_account] FOREIGN KEY ([account_no]) REFERENCES [asr_datastore].[account] ([account_no]),
    CONSTRAINT [fk_io_improvement] FOREIGN KEY ([account_no], [improvement_no]) REFERENCES [asr_datastore].[improvement] ([account_no], [improvement_no]) ON DELETE CASCADE
);
