...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = 'A subdivision filing is a group of parcels that exist as a sub-set of a larger subdivision.
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = 'The five digits number assigned by Assessor'' s office to each subdivision. There will be a subdivision record created for metes and bounds parcels. For example, subdivision no 05040 is HIGHLANDS RANCH.
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = 'This is the platted subdivision name. For example 05040 is HIGHLANDS RANCH', @level0type = N'SCHEMA', @level0name = N'asr_ods2', @level1type = N'TABLE', @level1name = N'sub_filing', @level2type = N'COLUMN', @level2name = N'subdivision_name';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = 'When a subdivision is developed in phases, each phase will be assigned a filing no.', @level0type = N'SCHEMA', @level0name = N'asr_ods2', @level1type = N'TABLE', @level1name = N'sub_filing', @level2type = N'COLUMN', @level2name = N'filing_no';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = 'An amendment is a change to the subdivision and/or filing. For example, there are originally 8 lots and the developer now wants 6 instead. He would do an amendment to replat the lots into 6 from the original 8.', @level0type = N'SCHEMA', @level0name = N'asr_ods2', @level1type = N'TABLE', @level1name = N'sub_filing', @level2type = N'COLUMN', @level2name = N'filing_description';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = 'A name of the subdivison filing that is different from the platted name.', @level0type = N'SCHEMA', @level0name = N'asr_ods2', @level1type = N'TABLE', @level1name = N'sub_filing', @level2type = N'COLUMN', @level2name = N'dedicated_sub_filing_name';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = 'Used to store a generated hash value for the row. The hash value is used in detecting changes to a row.', @level0type = N'SCHEMA', @level0name = N'asr_ods2', @level1type = N'TABLE', @level1name = N'sub_filing', @level2type = N'COLUMN', @level2name = N'rowhash';
