CREATE TABLE [asr_datastore].[improvement] (
    ...
    CONSTRAINT [fk_imp_account] FOREIGN KEY ([account_no]) REFERENCES [asr_datastore].[account] ([account_no]) ON DELETE CASCADE
);
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'This is the percent complete of the building as of the assessment date of the given year.', @level0type = N'SCHEMA', @level0name = N'asr_datastore', @level1type = N'TABLE', @level1name = N'improvement', @level2type = N'COLUMN', @level2name = N'completed_percent';
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'The linear measurement of the footprint of the building.', @level0type = N'SCHEMA', @level0name = N'asr_datastore', @level1type = N'TABLE', @level1name = N'improvement', @level2type = N'COLUMN', @level2name = N'improvement_perimeter';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'The total square footage of the building, including all Built As groups, excluding basements and mezzanines.  Othewise know as GLA or GBA.', @level0type = N'SCHEMA', @level0name = N'asr_datastore', @level1type = N'TABLE', @level1name = N'improvement', @level2type = N'COLUMN', @level2name = N'improvement_sf';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'The total leaseable size of the builiding in square foot.  Should be less than impsf.', @level0type = N'SCHEMA', @level0name = N'asr_datastore', @level1type = N'TABLE', @level1name = N'improvement', @level2type = N'COLUMN', @level2name = N'improvement_net_sf';
