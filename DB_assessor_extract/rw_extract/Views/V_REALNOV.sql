...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'rw_extract', @level1type = N'VIEW', @level1name = N'V_REALNOV';
