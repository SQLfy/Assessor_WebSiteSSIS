CREATE TABLE [asr_datastore].[account_valuation_Old] (
    ...
    CONSTRAINT [pk_account_valuation_Old] PRIMARY KEY CLUSTERED ([account_no] ASC, [valuation_class_code] ASC),
    CONSTRAINT [fk_av_account_Old] FOREIGN KEY ([account_no]) REFERENCES [asr_datastore].[account] ([account_no]) ON DELETE CASCADE
);
