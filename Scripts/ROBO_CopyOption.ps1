...
$logToServer = "\\PRRW2-APP01\e$\Photos\DATA\"
$logFileName = "2023Log_AppealsPR" #Make unique for each run
...
$sourceDirectory = "\\UARW2-APP01\e$\Photos\DATA\2023"
Write-Host "Source file count: "+ ( Get-ChildItem -Recurse $sourceDirectory | Measure-Object ).Count;

# STOP! Manually save off previous file directory before running unless you intend to overwrite.
# Or make a temp directory and plan on swapping after the robocopy.
$destinationDirectory = "\\PRRW2-APP01\e$\Photos\DATA\2023_ROBO_Temp\"
