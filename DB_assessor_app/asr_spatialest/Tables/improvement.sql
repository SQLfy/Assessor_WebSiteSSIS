...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'This is the percent complete of the building as of the assessment date of the given year.', @level0type = N'SCHEMA', @level0name = N'asr_spatialest', @level1type = N'TABLE', @level1name = N'improvement', @level2type = N'COLUMN', @level2name = N'completed_percent';
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'The total square footage of the building, including all Built As groups, excluding basements and mezzanines.  Othewise know as GLA or GBA.', @level0type = N'SCHEMA', @level0name = N'asr_spatialest', @level1type = N'TABLE', @level1name = N'improvement', @level2type = N'COLUMN', @level2name = N'improvement_sf';
