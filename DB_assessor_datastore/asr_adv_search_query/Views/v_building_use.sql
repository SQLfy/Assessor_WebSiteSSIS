...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'asr_adv_search_query', @level1type = N'VIEW', @level1name = N'v_building_use';
