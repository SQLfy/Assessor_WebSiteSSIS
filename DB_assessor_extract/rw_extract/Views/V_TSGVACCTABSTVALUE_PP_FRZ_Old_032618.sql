...
CREATE VIEW [rw_extract].[V_TSGVACCTABSTVALUE_PP_FRZ_Old_032618]
AS
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         ...
         Alias = 900
         Table = 1176
         O', @level0type = N'SCHEMA', @level0name = N'rw_extract', @level1type = N'VIEW', @level1name = N'V_TSGVACCTABSTVALUE_PP_FRZ_Old_032618';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'utput = 720
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'rw_extract', @level1type = N'VIEW', @level1name = N'V_TSGVACCTABSTVALUE_PP_FRZ_Old_032618';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'rw_extract', @level1type = N'VIEW', @level1name = N'V_TSGVACCTABSTVALUE_PP_FRZ_Old_032618';
