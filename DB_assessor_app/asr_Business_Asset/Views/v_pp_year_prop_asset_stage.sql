...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'asr_Business_Asset', @level1type = N'VIEW', @level1name = N'v_pp_year_prop_asset_stage';
