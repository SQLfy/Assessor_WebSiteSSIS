CREATE TABLE [asr_datastore].[value_from_tsgvacctabstvalue_state_assessed] (
    ...
    CONSTRAINT [pk_value_from_tsgvacctabstvalue_state_assessed] PRIMARY KEY CLUSTERED ([account_no] ASC, [tax_year] ASC, [valuation_class_code] ASC, [tax_district_no] ASC),
    CONSTRAINT [fk_tsgv_account_sa] FOREIGN KEY ([account_no]) REFERENCES [asr_datastore].[account] ([account_no]) ON DELETE CASCADE
);
