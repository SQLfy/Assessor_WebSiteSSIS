CREATE TABLE [asr_datastore].[account_neighborhood] (
    ...
    CONSTRAINT [fk_an_account] FOREIGN KEY ([account_no]) REFERENCES [asr_datastore].[account] ([account_no]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [fk_an_account]
    ON [asr_datastore].[account_neighborhood]([account_no] ASC);
