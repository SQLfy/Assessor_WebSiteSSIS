...
#        self.engine = sqal.create_engine(f'mssql+pyodbc://assessor_app_user:j6S%23E%26di3%29z%24@uadcetl-sql01.dcgov.douglas.co.us:1433/assessor_datastore?driver=ODBC+Driver+17+for+SQL+Server', echo=False)
        self.engine = sqal.create_engine(f'{db_conn_string}', echo=False)
